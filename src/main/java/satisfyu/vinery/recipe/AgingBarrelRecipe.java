...
public class AgingBarrelRecipe implements Recipe<Container> {
	...
	public AgingBarrelRecipe(ResourceLocation identifier, NonNullList<Ingredient> inputs, ItemStack output) {
	...
	public static class Serializer implements RecipeSerializer<AgingBarrelRecipe> {
		@Override
		public AgingBarrelRecipe fromJson(ResourceLocation id, JsonObject json) {
			...
			if (ingredients.isEmpty()) {
				...
				return new AgingBarrelRecipe(id, ingredients,
						ShapedRecipe.itemStackFromJson(GsonHelper.getAsJsonObject(json, "result")));
			}
		}

		@Override
		public AgingBarrelRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
			final var ingredients = NonNullList.withSize(buf.readVarInt(), Ingredient.EMPTY);
			ingredients.replaceAll(ignored -> Ingredient.fromNetwork(buf));
			return new AgingBarrelRecipe(id, ingredients, buf.readItem());
		}

		@Override
		public void toNetwork(FriendlyByteBuf buf, AgingBarrelRecipe recipe) {
