...
public class ApplePressGUI extends AbstractContainerScreen<ApplePressMenu> {
	private static final ResourceLocation TEXTURE = new VineryIdentifier("textures/gui/wine_press.png");

	public ApplePressGUI(ApplePressMenu handler, Inventory inventory, Component title) {
